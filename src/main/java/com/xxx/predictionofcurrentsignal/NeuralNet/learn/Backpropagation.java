package com.xxx.predictionofcurrentsignal.NeuralNet.learn;

import java.util.ArrayList;

import com.xxx.predictionofcurrentsignal.NeuralNet.HiddenLayer;
import com.xxx.predictionofcurrentsignal.NeuralNet.NeuralNet;
import com.xxx.predictionofcurrentsignal.NeuralNet.Neuron;
...
public class Backpropagation extends Training {
    ...
    public NeuralNet forward(NeuralNet n, int row) {
        ...
        if (listOfHiddenLayer.size() > 0) {
            ...
            for (HiddenLayer hiddenLayer : listOfHiddenLayer) {
                ...
                int numberOfNeuronsInLayer = n.getInputLayer().getNumberOfNeuronsInLayer();
    ...
    //预测
    public NeuralNet predict(NeuralNet n, int row) {
